...
def start_ai():
    ...
    while True:
        # reinitializing variables for each minute iteration
        ...
        while True:
            ...
            for output in layerOutputs:
                for detection in output:
                    ...
                    # if detected object's confidence is greater than 0.8 then add to list
                    if confidence > 0.8:
            ...
            # check whether human was detected, then show in a rectangular box
            for i in indexes:
                if class_ids[i] == 0:
                    x, y, w, h = boxes[i]
            ...
            # function to display the observation of the last scan
